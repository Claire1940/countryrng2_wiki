...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.countryrng2.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Country RNG 2 Wiki",
    description: "Read the Terms of Service for Country RNG 2 Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Country RNG 2 Wiki",
      title: "Terms of Service - Country RNG 2 Wiki",
      description: "Terms and conditions for using Country RNG 2 Wiki.",
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: "Country RNG 2 Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Country RNG 2 Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Country RNG 2 Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Country RNG 2 Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Country RNG 2 Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Country RNG 2". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Code tracking and free reward guides</li>
              <li>Country lists, flags, and rarity information</li>
              <li>Roll chance and probability explanations</li>
              <li>Luck upgrade tree and progression guides</li>
              <li>Gamepass reviews, events, and secret locations</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Country RNG 2 Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Country RNG 2. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Country RNG 2 Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Country RNG 2. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> The Roblox game Country RNG 2, its features, gamepasses, and content may change without notice. We are not responsible for game access or updates.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, COUNTRY RNG 2 WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Country RNG 2 Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@countryrng2.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@countryrng2.wiki</a>
            </p>
            <p>
